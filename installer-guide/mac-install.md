...
Setting up OpenCore's EFI environment is simple, all you need to do is mount our EFI system partition (`MyVolume`). This is automatically made when we format with GUID but is unmounted by default, this is where our friend [MountEFI](https://github.com/corpnewt/MountEFI) comes in:
